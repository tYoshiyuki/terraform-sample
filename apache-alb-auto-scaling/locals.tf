locals {
  ...
  aws_codedeploy_deployment_group_name    = "sample-apache-alb-asg-code-deploy-app-group"
  aws_codedeploy_deployment_group_bg_name = "sample-apache-alb-asg-code-deploy-app-group-bg"
}
